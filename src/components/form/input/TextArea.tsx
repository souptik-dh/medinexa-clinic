...
const TextArea: React.FC<TextareaProps> = ({
  ...
  if (disabled) {
    ...
    textareaClasses += ` bg-transparent text-gray-800 border-error-500 focus:border-error-500 focus:ring-3 focus:ring-error-500/10 dark:border-error-500 dark:bg-gray-900 dark:text-error-400`;
  } else {
