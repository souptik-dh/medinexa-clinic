...
import { notFound, forbidden, badRequest } from "@api/lib/errors";
import { parseBody } from "@api/lib/validators";
import { newId } from "@api/lib/ids";
import { autoCancelAppointmentsInRange } from "@api/lib/appointments";
import { autoCancelLabTestAppointmentsInRange } from "@api/lib/lab-tests";
import { notifyAutoCancelledDoctorAppointments, notifyAutoCancelledLabTestAppointments } from "@api/lib/schedule-cancellations";
