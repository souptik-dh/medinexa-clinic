...
import { pool, type Row, withTransaction } from "@api/lib/db";
import { requireRoles, type AuthContext } from "@api/lib/auth";
import { requireBranchAccess } from "@api/lib/permissions";
import { notFound, forbidden } from "@api/lib/errors";
import { parseBody } from "@api/lib/validators";
import { getBranchOperatingDays } from "@api/lib/availability";
